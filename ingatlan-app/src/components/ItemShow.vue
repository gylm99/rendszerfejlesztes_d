<template>
    <router-link to="/item">
    <div class="bg-white shadow rounded-lg overflow-hidden transform hover:scale-105 transition duration-300 ease-in-out text-center">
                    <div class="relative inline-block">
                     ...
                     <div class="grid grid-cols-3 px-4  text-sm">
                    ...
                    <div class="grid grid-cols-3 px-4 mb-2 text-sm">
                        <h3>Szeged</h3>
